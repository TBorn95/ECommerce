...
//Quelle: basierend auf https://stackoverflow.com/questions/3629596/deserializing-an-abstract-class-in-gson
public class CustomSerializer implements JsonSerializer<Object>, JsonDeserializer<Object> {
	...
	public JsonElement serialize(Object src, Type typeOfSrc, JsonSerializationContext context) {
		...
		object.addProperty(CLASS_KEY, "ePlattform.server.domainObjects."+src.getClass().getSimpleName());
		return object;
	}
